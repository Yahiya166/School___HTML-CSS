var Typer = function(element) {
  ...
  this.deleteDelay = element.dataset.deletedelay || element.dataset.deleteDelay || 200;
...
Typer.prototype.doTyping = function() {
  ...
  if (this.cursor) {
    ...
    this.cursor.interval = setInterval(() => this.cursor.updateBlinkState(), 100);
  }
...
var Cursor = function(element) {
  ...
  this.interval = setInterval(() => this.updateBlinkState(), 100);
}
